			...
			<div class="col-10 my-4">
				...
				<div class=container>
					<div class="row justify-content-center">
						<%
						PreparedStatement ps=con.prepareStatement("select * from rooms where rtype='Silver'");
						...
						<div
							...
							<a href="bookroom.jsp?rtype=Silver&rno=<%=rs.getInt(1) %>" class="btn btn-info">Book Room</a>
						</div>
						<%
						}
							else
						...
						<table class="table">
							...
							<tbody>
								<%
									...
									ResultSet rs1=st.executeQuery("select * from patient,rooms,room_booking where rooms.rtype='Silver' and rm_status='Booked' and room_booking.rno=rooms.rno and room_booking.pid=patient.pid");
