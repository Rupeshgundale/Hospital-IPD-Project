			...
			<div class="col-10 my-4">
				...
				<div class=container>
					<div class="row justify-content-center">
						<%
						PreparedStatement ps=con.prepareStatement("select * from general_ward2");
						...
						<div
							...
							<p class="card__exit">
								<img src=../feather/activity.svg>
							</p>
							<h2 class="card__title">
								Bed No :
								<%=rs.getInt(1) %></h2>
							<p class="card__apply">
								<a class="font-weight-bold">Rent / Day Rs. <%=rs.getInt(2) %>
								</a>
							
							</p>
							<a href="bookbed2.jsp?bno=<%=rs.getInt(1) %>" class="btn btn-info">Allocate</a>
						</div>
						<%
						}
							else
						...
						<table class="table">
							...
							<tbody>
								<%
									...
									ResultSet rs1=st.executeQuery("select * from patient,general_ward2,ward2_booking where  bedstatus='Booked' and ward2_booking.bedno=general_ward2.bed_no and ward2_booking.pid=patient.pid");
									...
									<tr>
										...
										<td class="table-danger"><%=rs1.getString(15) %></td>
										
									<td class="table-info "><a href=DeallocateWard2.jsp?bno=<%=rs1.getString(12) %> class="btn btn-warning">Deallocate</a></td>	</tr>
