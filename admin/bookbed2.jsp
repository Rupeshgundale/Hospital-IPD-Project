...
<body>
	...
	<div class=container-fluid>
		<div class=row>
			...
			<% String rno=request.getParameter("bno");
				...
				<div class=container>
					<div class="row justify-content-center">
						<div class="col-10 shadow p-3 mb-5 bg-white rounded">
							...
							<form action=BookWard2Data.jsp method=post id=frmBookRoom>
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Bed Number</label> <input
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Ward?</label> <input
										...
										value="GeneralWard2" readonly>
								</div>
								
								
								<input type="button" class="btn btn-success"
									style="width: 100%;" id=login value="Allocate Bed"
									onclick="bookroom()">
							</form>
						</div>
					</div>
