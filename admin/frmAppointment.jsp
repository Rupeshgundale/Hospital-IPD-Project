...
function bookAppointment()
{
	...
	if(subEmpty==0)
	{
		...
		document.getElementById("frmBookAppointment").submit();
				...
				<div class=container>
					<div class="row justify-content-center">
						<div class="col-10 shadow p-3 mb-5 bg-white rounded">
							...
							<form action=BookAppointment.jsp method=post id=frmBookAppointment>
								...
								<div class="form-group">
 								...
 								<div class="form-group">
									<label for="exampleInputEmail1">Appoint to Doctor</label> 
									<select class=form-control id=dname name=dname>
										
									<%
									PreparedStatement psdoc=con.prepareStatement("select * from doctor");
									
									ResultSet rsdoc=psdoc.executeQuery();
									while(rsdoc.next())
									{
										
										out.println("<option value="+rsdoc.getString(1)+">"+rsdoc.getString(2)+"</option>");
									}
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Registration Charges Rs.</label> <input
										type="text" class="form-control" id="txtcharges" name="txtcharges">
								</div>
								
								<input type="button" class="btn btn-success"
									style="width: 100%;" id=login value="Book Appointment"
