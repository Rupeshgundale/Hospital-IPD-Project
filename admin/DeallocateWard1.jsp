...
try
{
	PreparedStatement ps=con.prepareStatement("select * from general_ward1,ward1_booking ,patient where ward1_booking.bno=? and ward1_booking.pid=patient.pid and ward1_booking.bedno=general_ward1.bed_no");
	ps.setString(1,bno);
									...
									<div class="col-5 offset-1">
										<div class="form-group">
											<label for="exampleInputEmail1">Ward</label> <input
												...
												name="txtRtype" value=general_ward1 readonly
