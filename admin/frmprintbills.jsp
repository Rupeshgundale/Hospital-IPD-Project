			...
			<div class="col-10 my-4">
				...
				<div class=container>
					<div class="row justify-content-center">
						...
						<h2 class="text-info mb-4">Print Bills</h2>
						<table class="table">
							...
							<tbody>
								<%
									...
									ResultSet rs=st.executeQuery("select billno,bdate,pname,bno,rtype from bill,patient where bill.pid=patient.pid order by billno desc");
									while(rs.next())
									{
										%>
									<tr>
										...
										<td><a target=_blank href="printbill.jsp?billno=<%=rs.getString(1)%>" class="btn btn-info" >Print</a></td>
									</tr>
