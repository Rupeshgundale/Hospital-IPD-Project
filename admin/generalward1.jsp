			...
			<div class="col-10 my-4">
				...
				<div class=container>
					<div class="row justify-content-center">
						<%
						PreparedStatement ps=con.prepareStatement("select * from general_ward1");
						...
						<div
							...
							<a href="bookbed.jsp?bno=<%=rs.getInt(1) %>" class="btn btn-info">Allocate</a>
						</div>
						<%
						}
							else
						...
						<table class="table">
							...
							<tbody>
								<%
									...
									ResultSet rs1=st.executeQuery("select * from patient,general_ward1,ward1_booking where  bedstatus='Booked' and ward1_booking.bedno=general_ward1.bed_no and ward1_booking.pid=patient.pid");
									...
									<tr>
										...
										<td class="table-info "><a href=DeallocateWard1.jsp?bno=<%=rs1.getString(12) %> class="btn btn-warning">Deallocate</a></td>
									</tr>
