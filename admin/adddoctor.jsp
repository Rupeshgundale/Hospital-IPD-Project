							...
							<form action=addDoctorData.jsp method=get id=frmDocRegister>
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Mobile No </label> <input
										type="text" class="form-control" id="txtmob"
										name="txtmob"
								...
								<div class="form-group">
									...
									<textarea area class="form-control" id="txtadd" name="txtadd" onblur="validateEmpty(this,document.getElementById('errAdd'),'Enter Address')"></textarea>
								...
								<div class="form-group">
									...
									<select class="form-control" id="txtedu" name="txtedu">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Experience</label> <input
										type="text" class="form-control" id="txtexp"
										name="txtexp"
										onblur="validateNumber(this,document.getElementById('errExp'),'Enter Valid Number')">
									<small id="errExp" class="text-danger"></small>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">Specialization</label> <input
										type="text" class="form-control" id="txtspe"
										name="txtspe"
										onblur="validateEmpty(this,document.getElementById('errSpe'),'Invalid Field')">
									<small id="errSpe" class="text-danger"></small>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">UserName</label> <input
										type="text" class="form-control" id="txtuname"
										name="txtuname"
										onkeyup="validateUsername(this,document.getElementById('errUsername'),'Enter Username')">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">Password</label> <input
										...
										name="txtPassword"
										onblur="validatePassword(this,document.getElementById('errPassword'),'Weak Password','Strong Password')">
									<small id="errPassword" class="text-danger"></small>
								</div>
								<input type="button" class="btn btn-primary"
									style="width: 100%;" id=login value=Register onclick="registerDoctor()">
							</form>
						</div>
					</div>
				</div>
