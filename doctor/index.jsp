...
<body>
<%
if(session.getAttribute("ipdadoctor")!=null)
{
	response.sendRedirect("admindashboard.jsp");
}
%>

<form action=authenticate_doctor.jsp method=get>
<div class="container frm">
 ...
 <div class="col-4 align-self-center shadow p-3 mb-5 bg-white rounded">
  ...
  <div class="form-group" >
   <label for="exampleInputEmail1" class="bg-info " style="width:100%;padding:15px;text-align:center;">Doctors Login</label><br>
  </div>
