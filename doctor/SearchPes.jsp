					...
					<div class="row justify-content-center">
						<div class="col-10 shadow p-3 mb-5 bg-white rounded">
							...
							<form action=patientDet.jsp method=get id=frmBookRoom>
								...
								<input type="submit" class="btn btn-success" style="width: 100%;" id=login value="Get Patient Details">
